...
if(isNull _organThief) exitWith {}; //if not the thief get bent
	...
	[[1,format["%1 hat %2 eine Niere entfernt.",name _organThief,name player]],"life_fnc_broadcast",nil,false] spawn life_fnc_MP;		//lets people know you are stealing kidneys
